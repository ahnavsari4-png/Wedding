...
export const CoupleStory: React.FC<CoupleStoryProps> = ({ isGujarati }) => {
  return (
    <section id="couple" className="py-16 sm:py-24 bg-[#FDF9F2] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch mb-16">
          {/* Groom Profile Card */}
          <div className="bg-[#FAF4EB] rounded-3xl p-6 sm:p-8 border border-[#8C2D19]/30 shadow-lg relative overflow-hidden flex flex-col justify-between hover:shadow-xl transition-shadow">
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden border-2 border-[#8C2D19] shadow-md shrink-0 ring-2 ring-[#D97706]/40">
                  <img
                ...
                <div>
                  <div className="inline-block bg-[#8C2D19] text-[#FDE68A] text-[10px] uppercase tracking-wider font-bold px-2.5 py-0.5 rounded-full mb-1">
                    {isGujarati ? 'વરરાજા' : 'The Groom'}
                  </div>
                  <h3 className="font-serif-gu text-xl sm:text-2xl font-bold text-[#8C2D19]">
              ...
              <p className="font-serif-gu text-xs sm:text-sm text-[#701D0E] leading-relaxed mb-6 bg-white/80 p-3.5 rounded-xl border border-[#8C2D19]/20 shadow-inner">
              ...
              <div className="space-y-2.5 text-xs text-[#4A2810]">
                <div className="flex items-start space-x-2.5">
                  <GraduationCap className="w-4 h-4 text-[#8C2D19] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#8C2D19]">શિક્ષણ: </span>
                    <span>{WEDDING_DETAILS.groom.educationGu}</span>
                  </div>
                </div>

                <div className="flex items-start space-x-2.5">
                  <Briefcase className="w-4 h-4 text-[#8C2D19] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#8C2D19]">વ્યવસાય: </span>
                    <span>{WEDDING_DETAILS.groom.professionGu}</span>
                  </div>
                </div>

                <div className="flex items-start space-x-2.5">
                  <User className="w-4 h-4 text-[#8C2D19] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#8C2D19]">માતા-પિતા: </span>
                ...
                <div className="flex items-start space-x-2.5">
                  ...
                  <div>
                    <span className="font-semibold text-[#8C2D19]">મૂળ વતન: </span>
            ...
            <div className="mt-6 pt-4 border-t border-[#8C2D19]/30 flex items-center justify-between text-[11px] text-[#701D0E] font-medium">
              <span>કુળદેવી: શ્રી ઉમિયા માતાજી</span>
              <span className="font-bold text-[#8C2D19]">પટેલ પરિવાર (ભૈરવી)</span>
            </div>
          </div>
          ...
          <div className="bg-[#FAF4EB] rounded-3xl p-6 sm:p-8 border border-[#8C2D19]/30 shadow-lg relative overflow-hidden flex flex-col justify-between hover:shadow-xl transition-shadow">
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <div className="inline-block bg-[#701D0E] text-[#FDE68A] text-[10px] uppercase tracking-wider font-bold px-2.5 py-0.5 rounded-full mb-1">
            ...
            <div className="mt-6 pt-4 border-t border-[#8C2D19]/30 flex items-center justify-between text-[11px] text-[#701D0E] font-medium">
              ...
              <span className="font-bold text-[#8C2D19]">પટેલ પરિવાર (રાનકુવા)</span>
            </div>
          </div>
        </div>

        {/* Love Story / How Destiny Connected Them with Tribal Warli Tree of Life */}
        <div className="bg-gradient-to-r from-[#701D0E] via-[#8C2D19] to-[#701D0E] text-[#FDE68A] rounded-3xl p-6 sm:p-10 shadow-xl border-2 border-[#D97706] relative overflow-hidden">
          <div className="max-w-3xl mx-auto text-center relative z-10">
            <div className="flex justify-center mb-3">
              <WarliTreeOfLife color="#FDE68A" className="w-32 h-20 opacity-80" />
            </div>
            ...
            <p className="font-serif-gu text-xs sm:text-base text-white/95 leading-relaxed">
              {isGujarati
                ? 'ડો. હર્ષ અને ડો. ટવિન્ક્લ બંને તબીબી શિક્ષણ તથા સેવાભાવના સમાન મૂલ્યો સાથે જોડાયા છે. બંનેના ઉમદા વિચારો, જીવન પ્રત્યેનો આદર અને પારિવારિક સંસ્કારો પ્રત્યેની શ્રદ્ધાએ એક અનોખો સ્નેહસેતુ રચ્યો. વડીલોના મંગળ આશીર્વાદ સાથે આ સંબંધ પવિત્ર લગ્નગ્રંથિમાં પરિણમી રહ્યો છે.'
            ...
            <div className="mt-6 inline-flex items-center space-x-2 text-xs font-serif-gu text-[#FDE68A] bg-black/25 px-5 py-2 rounded-full border border-[#D97706]/40 shadow-sm">
