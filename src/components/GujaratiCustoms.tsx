...
export const GujaratiCustoms: React.FC<GujaratiCustomsProps> = ({ isGujarati }) => {
  ...
  return (
    <section id="customs" className="py-16 sm:py-24 bg-[#FFFDF9] relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {GUJARATI_CUSTOMS.map((custom, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-[#FAF5EE] rounded-2xl p-6 border border-[#E8DFC8] shadow-sm hover:shadow-md transition-all flex flex-col justify-between hover:border-[#D4AF37]"
              >
                <div>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#851214] to-[#C41E3A] text-[#FDE68A] flex items-center justify-center shadow-md mb-4">
                    <IconComp className="w-6 h-6" />
                  </div>

                  <h3 className="font-serif-gu text-lg font-bold text-[#851214] mb-2">
                ...
                <div className="bg-white/80 p-3 rounded-xl border border-[#E8DFC8] text-xs font-serif-gu text-[#78350F]">
                  <span className="font-bold text-[#851214]">મહત્વ: </span>
                  {custom.meaningGu}
                </div>
              </div>
            );
        ...
        <div className="mt-12 bg-[#FAF5EE] rounded-3xl p-6 sm:p-8 border-2 border-[#D4AF37]/50 shadow-md">
          <div className="text-center max-w-xl mx-auto mb-6">
            <span className="text-xs font-bold uppercase tracking-widest text-[#851214]">
              સપ્તપદી સંકલ્પ
            </span>
            <h3 className="font-serif-gu text-xl sm:text-2xl font-bold text-[#851214] mt-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs font-serif-gu">
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8]">
              <div className="font-bold text-[#851214] mb-1">૧. પ્રથમ પદ (અન્ન & પોષણ)</div>
              <p className="text-[#4B5563]">પરિવારના શુદ્ધ પોષણ અને તંદુરસ્તીની જવાબદારી સાથે નિભાવશું.</p>
            </div>
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8]">
              <div className="font-bold text-[#851214] mb-1">૨. દ્વિતીય પદ (બળ & સામર્થ્ય)</div>
              <p className="text-[#4B5563]">જીવનના દરેક સંઘર્ષમાં એકબીજાની ઢાલ અને શક્તિ બનીને ઊભા રહીશું.</p>
            </div>
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8]">
              <div className="font-bold text-[#851214] mb-1">૩. તૃતીય પદ (ધન & સમૃદ્ધિ)</div>
              <p className="text-[#4B5563]">સત્ય અને નીતિથી ધન કમાઈ ગૃહસ્થ ધર્મનું સુખેથી પાલન કરીશું.</p>
            </div>
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8]">
              <div className="font-bold text-[#851214] mb-1">૪. ચતુર્થ પદ (સુખ & આનંદ)</div>
              <p className="text-[#4B5563]">પરસ્પર આદર અને સ્નેહથી પરિવારમાં સદા હાસ્ય અને શાંતિ જાળવીશું.</p>
            </div>
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8]">
              <div className="font-bold text-[#851214] mb-1">૫. પંચમ પદ (સંસ્કાર & વંશ)</div>
              <p className="text-[#4B5563]">આવનારી પેઢીને ઉત્તમ સંસ્કારો અને સદ્વિચારોનું વારસો આપીશું.</p>
            </div>
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8]">
              <div className="font-bold text-[#851214] mb-1">૬. ષષ્ઠ પદ (ઋતુઓ & સાથ)</div>
              <p className="text-[#4B5563]">દરેક ઋતુ અને સમયના બદલાવમાં અમારો પ્રેમ અખંડ અને અડગ રહેશે.</p>
            </div>
            <div className="bg-white p-3 rounded-xl border border-[#E8DFC8] sm:col-span-2">
              <div className="font-bold text-[#851214] mb-1">૭. સપ્તમ પદ (શાશ્વત મૈત્રી & એકતા)</div>
